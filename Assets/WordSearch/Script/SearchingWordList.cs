...
public class SearchingWordList : MonoBehaviour
{
    ...
    void Start()
    {
        _wordsNumber = currentGameData.puzzleBoardData.SearchWords.Count;
    ...
    private void CreateWordObject()
    {
        ...
        for(var index = 0; index < _wordsNumber; index++)
        {
            ...
            _words[index].GetComponent<SearchingWord>().SetWord(currentGameData.puzzleBoardData.SearchWords[index].word,
                                                                currentGameData.puzzleBoardData.SearchWords[index].questions);
        }
    }
    ...
    private void SetWordsPosition()
    {
        ...
        int columnNumber = 0;
        int rowNumber = 0;
        var startPosition = GetSquareFirstPosition();
    ...
    private Vector2 GetSquareFirstPosition()
    {
